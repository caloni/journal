...
{{< image src="IGR3VJC.png" caption="Erro de automação?" >}}
...
{{< image src="l7Rc7kY.png" caption="Exportando e importando registro" >}}
...
{{< image src="hhxZgqZ.png" caption="Snapshots da VMWare" >}}
