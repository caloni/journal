...
![Atalhos do Trello](http://i.imgur.com/747UasT.png)
...
![Pedindo autorização para o Trello](http://i.imgur.com/oQ97bDI.png)
...
![ID único de um Card](http://i.imgur.com/xONdnSw.png)
...
![Hello, World!](http://i.imgur.com/rbCigTV.png)
...
![Adicionando um WebHook ao GitHub](http://i.imgur.com/4Lph9w6.png)
...
![Comitando o artigo para gerar evento que irá comentar no Trello para continuar este artigo que estou comitando..](http://i.imgur.com/NzQPB9o.png)

O que vai deixar você perplexo é entender como esse texto está sendo comitado antes mesmo de eu comitar este texto ;).

![Resultado do meu commit](http://i.imgur.com/ZIPNSpV.png)

E o negócio é rápido, viu?

![E o negócio é rápido, viu?](http://i.imgur.com/vVmuKb7.png)
