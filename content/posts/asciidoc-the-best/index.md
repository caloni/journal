---
categories: null
date: '2023-06-04T21:31:20-03:00'
draft: true
tags: null
title: Asciidoc is the best and is the final solution
---

After reading about the purpose and [current implementation of asciidoctor] I realize that asciidoc is the best text standard for the future of the blog. I say that based on the structure care of the format, that embebbed metadata into its own format and has the clear objective of being a unique and formalized standard, what could simplify a lot the necessity of writers and publishers of keep a raw text as original and yet has the structure inside with almost no penalty for the writers.

Based also on the article [Why I Built My Own Shitty Static Site Generator] I also realized hugo is not the final tool to convert my blog into the publishing final products. I need to implement this tool, for my single oriented purpose. Being that, the use of Hugo will be temporarily.
...
I expect to keep or reconstruct the text history based in this single folder, but I am not sure yet if I am going that and what is the final value of that.
