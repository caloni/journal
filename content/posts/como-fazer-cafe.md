...
Uma vez torrado, o café começa a perder essas propriedades rapidamente através de sua superfície. Após uma embalagem a vácuo ser aberta, no decorrer de quatro a cinco semana a maioria dos cafés torrados, expostos ao ambiente, estarão livre de muitos aromas que surgem durante a torra. Esse tempo diminui se os grãos já estiverem moídos na proporção de quão mais superfície está disponível no pó do café para que essas propriedades vazem para o ambiente. Por outro lado, é preciso lembrar também que como a torra envolve queimar o café isso gera gás carbônico, e parte dele ainda está nos grãos do café nos primeiros dias; o que quer dizer quem uma torra muito recente também não é o melhor estágio para extrair suas propriedades.
...
Independente do processo e medidas utilizadas tenha isso em mente: fazer café é extrair suas propriedades químicas do fruto para a água. Essa extração pode retirar mais ou menos do café. Por ordem de exposição (tempo + superfície + temperatura), a água retira esses sabores básicos do seu café: acidez, corpo, doçura, corpo, amargor. Quanto mais equilibrada a extração mais essas propriedades trabalharão juntos quando você degustar seu café, em harmonia. O que quer dizer que você conseguirá obter mais sensações a cada gole. Mais sensações é uma coisa boa, pois torna a bebida mais complexa. Mais complexidade é bom porque torna a experiência mais intensa, demandando mais nossa atenção e proporcionando uma experiência mais rica.

Uma última observação e curiosidade sobre o equilíbrio e harmonia no café a respeito do pó. Existe um efeito colateral em moagens muito finas em que a água fica impedida de prosseguir seu caminho e acaba encontrando no meio do café alguns caminhos que cedem mais facilmente. Isso é ruim porque ela irá passar por alguns lugares e não por outros. O café estará desbalanceado, pois ficará super-extraído em algumas partes e sub-extraído em outras. Apenas uma curiosidade que pode explicar alguns efeitos indesejáveis que você possa observar.

## Método

Como já visto, a superfície do café é responsável pelo desgaste do tempo. Sendo assim, o melhor investimento em equipamento para fazer café que você pode fazer é em um moedor, para que você possa adquirir café em grãos, que desgastam mais lentamente. Caso você consuma grãos previamente moídos tente sempre obtê-los em pacotes menores para expor menos café quando for abrir a embalagem. O moedor é importante para manter a ideia do frescor e qualidade dos ingredientes para fazer seu café. Após isso todo o resto é menos importante, pois qualquer técnica bem executada em cima de excelentes grãos irá fazer pelo menos um ótimo café.
...
Como medir tudo isso? Usando um padrão. Um padrão para aquecer sua água e ter uma noção da temperatura (caso não tenha um termômetro). Um padrão para saber quanto de café por xícara está sendo utilizado. Um padrão para medir o tempo de extração. Nem tudo poderá ser controlado, mas outro objetivo além do controle é prestar atenção em qual é a sua receita de hoje você pode alterá-la amanhã.
