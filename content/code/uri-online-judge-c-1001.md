...
draft: true
---
O exercício mais básico do site [URI Online Judge](https://www.urionlinejudge.com.br/judge/pt) que você poderá encontrar é ler dois números e imprimir a soma. Há muitas coisas que podemos aprender por um programa que resolva esse exercício que poderá servir para outros mais complexos:
...
E é isso. Ao compilar esse programa essa função `main` será chamda e executará todo o código contido dentro dela, irá retornar para o ambiente criado para sua execução (geralmente criado pela `libc` antes de chegar no `main`) e o programa irá terminar. No momento todo o código contido dentro dela é nenhum, e ela deveria retornar um inteiro aleatório contido na pilha de chamadas, pois sequer estamos retornando algo para quem nos chamou, embora por definição `main` deva retornar um inteiro (`int`).
