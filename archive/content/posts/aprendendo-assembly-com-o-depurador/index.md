...
{{< image src="debug-testpng.png" caption="Teste do debug 16 bits" >}}
...
{{< image src="windbgxnotepad.png" caption="WinDbg x Notepad" >}}
...
[bugs escabrosos]: {{< relref "analisando-dumps-com-windbg-e-ida" >}}
[aqui no bloque]: {{< relref "depuracao-da-mbr" >}}
[Guia básico para programadores de primeiro breakpoint]: {{< relref "guia-basico-para-programadores-de-primeiro-breakpoint" >}}
[Brincando com o WinDbg]: {{< relref "brincando-com-o-windbg" >}}
[Encontrando as respostas do Flash Pops]: {{< relref "encontrando-as-respostas-do-flash-pops" >}}
[Hook de API no WinDbg]: {{< relref "hook-de-api-no-windbg" >}}
[Hook de COM no WinDbg]: {{< relref "hook-de-com-no-windbg" >}}
[Detectando hooks globais no WinDbg]: {{< relref "detectando-hooks-globais-no-windbg" >}}
[Analisando dumps com WinDbg e IDA]: {{< relref "analisando-dumps-com-windbg-e-ida" >}}