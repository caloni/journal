...
Pontos fortes: a discrepância entre ambas as casas chega a quase criar uma personalidade diferenciada para cada uma, e a confecção da textura de cerâmica nos bonecos chega a impressionar por alguns momentos.

Pontos fracos: referências descartáveis a outros filmes, roteiro com falhas de lógica gritantes (como quando o cogumelo amigo de Gnomeu o procura para dizer que Julieta corre perigo, sendo que ele sequer sabia disso) e dublagens pavorosas no elenco brasileiro.

Se você gostou disso, não deixe de ver:
