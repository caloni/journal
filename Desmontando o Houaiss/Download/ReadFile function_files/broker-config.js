...
var _msdn = [ ["default.aspx",'1175',0.3],["library/windows/apps",'1458',0.083],["library",'1176',0.24],["ie",'1177',0.3],["netframework",'1178',0.19],["windowsazure",'1179',0.13],["magazine",'1180',0.30], ["office",'1181',0.3],["sharepoint",'1183',0.13],["sqlserver",'1184',0.083],["subscriptions",'1185',0.19],["vbasic",'1186',0.3], ["vcsharp",'1187',0.3],["visualc",'1188',0.3],["vstudio",'1189',0.083],["windows/apps",'1457',0.083],["windows",'1190',0.077]  ];
//(TECHNET)-/en-us/(TIER 5) - CUSTOM - Make frequency changes here for tehnet.microsoft.com/en-us/…(various paths)
//Array [PATH,SITE_CODE,FREQ]
var _technet = [ ["default.aspx",'1219',0.3],["library",'1192',0.3],["windowsserver",'1194',0.13],["forefront",'1011',0.3],["office",'1195',0.2], ["sharepoint",'1196',0.3],["sqlserver",'1197',0.3],["systemcenter",'1198',0.3],["windows",'1199',0.016],["scriptcenter",'1200',0.3],["security",'1202',0.2], ["sysinternals",'1203',0.016],["virtualization",'1205',0.3],["subscriptions",'1206',0.19],["magazine",'623',0.19],["ie",'1220',0.3],["exchange",'1221',0.3],["edge",'1222',0.3]  ];
...
function checkWTSP(){
	if(_Site == '1176'){
		...
		if(!(_wtsp=="_technet_library_windowsserver_" || _wtsp=="_technet_prodtechnol_office_" || _wtsp=="_technet_library_sqlserver_" || _wtsp=="_sto_technet_systemcenter_" || _wtsp=="_technet_library_win7_" || _wtsp=="scriptcenter_technet" || _wtsp=="_technet_library_security_" || _wtsp=="_technet_library_ie_" || _wtsp=="_technet_library_exchangeserver_" || _wtsp=="_technet_sharepoint_library")){	
				_halt=true;
		} 
		if(_wtsp=="_technet_library_ie_" || _wtsp=="_technet_library_sqlserver_"){
			...
			_Freq=0.016;
		}else if(_wtsp=="_technet_library_windowsserver_"){
			_Freq=0.13;
		}else if(_wtsp=="_technet_library_security_" || _wtsp=="_technet_prodtechnol_office_"){
			_Freq=0.2;
		}else if(_wtsp=="_technet_sharepoint_library"){
			_Freq=0.06;
...
COMSCORE.SiteRecruit.Broker.config={version:"4.6.3",testMode:false,cookie:{name:"msresearch",path:"/",domain:".microsoft.com",duration:90,rapidDuration:0,expireDate:""},prefixUrl:"",mapping:[{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/de-de/",c:"inv_c_MSDN-p15466742-DE-DE.js",f:0.041,p:1},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/en-us/((default\\.aspx)|(windows/)|(library|ie|netframework|windowsazure|magazine|office|sharepoint|sqlserver|subscriptions|vbasic|vcsharp|visualc|vstudio)|(windows/apps)|(library/windows/apps))",c:"inv_c_MSDN-p77596864_TIER5.js",f:_Freq,p:1,halt:_halt},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/en-us/library",c:"inv_c_MSDN-p77596864_ALM.js",f:0.016,p:2,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"ALM_other|ALM_architect|ALM_dev|ALM_data|ALM_debug|ALM_TF_AO|ALM_TF_PM|ALM_TF_Build|ALM_TF_VC|ALM_TF_SDK|ALM_lab|ALM_test|ALM_VFP"}],cookie:[]}},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/en-us/library",c:"inv_c_MSDN-p77596864_NDP.js",f:0.016,p:2,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"NDP_CLR|NDP_CLR_SL|NDP_SL|NDP_WPF_SL|NDP_Other"}],cookie:[]}},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/en-us/library",c:"inv_c_MSDN-p77596864_VS.js",f:0.016,p:2,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"VS_Video|VS_Other|VS_BzApp_SMB|VS_BzApp_Other|VS_Lang_CS|VS_Lang_FS|VS_Lang_VB|VS_Lang_ML|VS_Lang_SL|VS_Lang_Other|VS_NonPro_ML|VS_PCP|VS_VSPE_VSPlat|VS_VSPE_Other|VS_TC_Solver|VS_VSPE_VSSDK|VS_VC|VS_ISVNT_Other|VS_NonPro_VC"}],cookie:[]}},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/en-us/library",c:"inv_c_MSDN-p77596864_Web.js",f:0.016,p:2,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"NDP_ASPNET|NDP_ASPNET_ACT|NDP_ASPNET_MVC|NDP_ASPNET_VWD|NDP_IIS_WinSDK|NDP_IIS|NDP_ASPNET_SL|VS_BzApp_SharePoint|VS_JScript"}],cookie:[]}},{m:"/(sr-msdn|msdnstage|msdntest|msdnlive|msdn\\.microsoft)[\\w\\.-]+/ja-jp",c:"inv_c_MSDN-p15466742-JA.js",f:0.0022,p:0},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/Forums/en-(us|US)",c:"inv_c_SC-MSDN-p77596864-p77737117-Tier1.js",f:0.19,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"netframework"}],cookie:[]}},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/Forums/en-(us|US)",c:"inv_c_SC-MSDN-p77596864-p77737117-Tier2.js",f:0.3,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"vbasic|vcsharp|visualc"}],cookie:[]}},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/Forums/en-(us|US)",c:"inv_c_SC-MSDN-p77596864-p77737117-Tier3.js",f:0.3,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"ie|office|windowsazure|sharepoint"}],cookie:[]}},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/Forums/en-(us|US)",c:"inv_c_SC-MSDN-p77596864-p77737117-Tier4.js",f:0.083,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"vstudio|sqlserver"}],cookie:[]}},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/Forums/en-(us|US)",c:"inv_c_SC-MSDN-p77596864-p77737117-Tier5.js",f:0.077,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"windows"}],cookie:[]}},{m:"(.*?social\\.msdn\\.microsoft)[\\w\\.-/]+/forums/en-(us|US)/category/windowsapps",c:"inv_c_SC-MSDN-p77596864-1459.js",f:0.083,p:2},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/Forums/en/",c:"inv_c_SC-TN-p77596864-p77737117-1308.js",f:0.3,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"scriptcenter"}],cookie:[]}},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/Forums/en/",c:"inv_c_SC-TN-p77596864-1308.js",f:0.016,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"windows"}],cookie:[]}},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/Forums/en/",c:"inv_c_SC-TN-p77596864-1308-winserver.js",f:0.13,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"windowsserver"}],cookie:[]}},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/forums/en-(us|US)",c:"inv_c_SC-TN-p77596864-p77737117-TIER3.js",f:0.2,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"office"}],cookie:[]}},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/forums/en-(us|US)",c:"inv_c_SC-TN-p77596864-p77737117-TIER1.js",f:0.13,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"windowsserver"}],cookie:[]}},{m:"(.*?social\\.technet\\.microsoft|sr-technet)[\\w\\.-]+/forums/en-(us|US)",c:"inv_c_SC-TN-p77596864-p77737117-TIER2.js",f:0.3,p:1,prereqs:{content:[{"element":"meta","attrib":"content","attribValue":"forefront|sharepoint|sqlserver|exchange|scriptcenter|systemcenter"}],cookie:[]}},{m:"/(sr-technet|tnstage|tnlive|tntest|technet\\.microsoft)[\\w\\.-]+/de-de/",c:"inv_c_TN-p15466742-p81712691-DE.js",f:0.048,p:2},{m:"/(sr-technet|tnstage|tnlive|tntest|technet\\.microsoft)[\\w\\.-]+/en-us/((default\\.aspx)|(windows/)|(library|windowsserver|forefront|office|sharepoint|sqlserver|systemcenter|scriptcenter|security|sysinternals|virtualization|subscriptions|magazine|ie|exchange|edge))",c:"inv_c_TechNet-p77596864.js",f:_Freq,p:1,halt:_halt},{m:"/(sr-technet|tnstage|tnlive|tntest|technet\\.microsoft)[\\w\\.-]+/ja-jp",c:"inv_c_TECHNET-p15466742-p81712691-JA.js",f:0.0042,p:1}]};
