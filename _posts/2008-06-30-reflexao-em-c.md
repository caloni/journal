...
Apenas se lembre de ter de fato uma classe polimórfica (eu consegui isso tornando MyMethod uma função virtual). Do contrário você pode [ter problemas](http://www.caloni.com.br/blog/archives/typeid-e-os-perigos-do-nao-polimorfismo).
