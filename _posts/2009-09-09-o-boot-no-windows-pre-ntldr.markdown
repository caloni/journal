...
O meu [primeiro artigo](http://www.caloni.com.br/blog/archives/o-boot-no-windows-sem-windows) sobre o boot sem Windows foi 80% escrito com o que eu já sabia de cabeça de tanto [mexer na MBR](http://www.caloni.com.br/blog/archives/depuracao-da-mbr)  e de tanto [depurar o processo de boot em 16 bits](http://www.caloni.com.br/blog/archives/debug-da-bios-com-o-softice-16-bits). Os artigos posteriores seriam escritos com uma pitada do que sei mais a "inspiração" da minha pesquisa. Apesar de não parecer pouco para os que não sabem inglês, deixa a desejar para os que sabem (boa parte dos meus leitores, imagino).
...
[](http://www.caloni.com.br/blog/wp-content/uploads/boot-map.png)


[![boot-map.png](http://www.caloni.com.br/blog/wp-content/uploads/boot-map.png)](http://www.caloni.com.br/blog/wp-content/uploads/boot-map.png)
...
![boot-components.png](http://www.caloni.com.br/blog/wp-content/uploads/boot-components.png)


Se o NTLDR não conseguir ser encontrado, o seguinte erro será exibido:


![error-ntldr-missing.png](http://www.caloni.com.br/blog/wp-content/uploads/error-ntldr-missing.png)
...
![finding-part-boot.png](http://www.caloni.com.br/blog/wp-content/uploads/finding-part-boot.png)


(4) uma simples conversão de Little Endian e de hexadecimal para decimal nos retorna o número do setor que precisamos;


![converting-setor.png](http://www.caloni.com.br/blog/wp-content/uploads/converting-setor.png)


(5) o próprio HxD nos consegue levar para esse setor, de onde podemos selecioná-lo e salvá-lo em um arquivo!


![first-partition-sector.png](http://www.caloni.com.br/blog/wp-content/uploads/first-partition-sector.png)
...
![error-checking-part-sect-signature.png](http://www.caloni.com.br/blog/wp-content/uploads/error-checking-part-sect-signature.png)
