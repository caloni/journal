...
![Cientista Feliz](/images/cientistafeliz.png)Uma [prova de conceito](http://en.wikipedia.org/wiki/Proof_of_concept) bem feita segue todos os passos em uma **forma micro** para entender e provar como as coisas irão funcionar no código de produção: a **forma macro**.
...
Além de serem extremamente divertidas e disputadas entre os programadores, desenvolver provas de conceito gera uma gama de vantagens para o desenvolvimento "sério" do software como um todo, "rodável" e "vendável":
  ...
  * Consegue tornar o milagre do [cronograma realista](http://www.caloni.com.br/blog/cronograma) mais perto do provável.
