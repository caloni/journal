...
A memória é **qualquer lugar** onde eu possa **guardar alguma coisa**. No [artigo anterior](http://www.caloni.com.br/blog/basico-do-basico-ponteiros) era um punhado de [gavetas](/images/pointers-drawer.gif). Mas poderiam muito bem ser caixas de presente. Ou um caderno. Ou até uma placa de memória RAM. O que sua criatividade quiser.
...
![Bloco de Notas acessando memória RAM.](/images/bloco-de-notas-acesando-memoria-ram.gif)
...
Na programação do dia-a-dia, as coisas funcionam da mesma forma. As tão faladas variáveis reservam um espaço de memória para guardar alguma coisa, mas só sabemos o que essa alguma coisa é através do tipo da variável:
    ...
    <font color="#339966">// a variável idade (espaço de memória)
...
[![Interpretação de memória de texto e números em um programa C.](/images/interpretacao-de-memoria-texto-e-numeros.png)](/images/interpretacao-de-memoria-texto-e-numeros.png)
