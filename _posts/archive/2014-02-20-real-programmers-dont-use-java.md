...
**Debugging.** Are you saying that you need the source code in order to debug? So you do not have a clue of what the program does. Just a few glances at [call stack](http://www.caloni.com.br/blog/aprendendo-assembly-com-o-depurador) and [the registers](http://www.caloni.com.br/blog/basico-do-basico-assembly) can make a Real Programmer solve a bug that Quiche Eaters would not get after analyzing those charts with boxes inside UML and use cases for months.
