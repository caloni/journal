...
tags: [ "linux", "ferramentas", "testdisk", "gpt", "suporte" ]
...
![](/images/sysrescurcd-testdisk-restore-partition-table.png)
...
![](/images/mbr-bootable-ntfs-w764-part.png)
...
![](/images/windows-cd-recovery-first-step.png)

No segundo boot ele já encontra a instalação:

![](/images/windows-cd-recovery-second-step.png)

E, acreditem só, ele descobre que o BOOTMGR está faltando!

![](/images/cd-windows-repair-boot-manager.png)
...
![](/images/diskmgr-efi-partition.png)
