...
**Entrar o foco na VM. Digite Ctrl + G.** Todos seus movimentos de teclado e mouse só irão funcionar dentro da máquina virtual, exceto o Ctrl + Alt + Del, exclusividade do [sistema de autenticação do Windows](http://www.caloni.com.br/blog/archives/gina-x-credential-provider).
...
#### Dois usos muito úteis para uma VM
  ...
  * Testes que costumam alterar o estado da máquina. Driver, [GINA](http://www.caloni.com.br/blog/archives/gina-x-credential-provider) ou [serviço](http://www.caloni.com.br/blog/archives/como-rodar-qualquer-coisa-como-servico) novo? Que tal usar uma VM para fazer os testes iniciais e parar de reformatar o Windows?
