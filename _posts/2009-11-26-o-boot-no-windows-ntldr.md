...
![galinha-preta.jpg](http://www.caloni.com.br/blog/wp-content/uploads/galinha-preta.jpg)Minhas análises estão demorando muito para ser feitas. Talvez seja a hora de revelar o pouco que sei (e pesquisei) sobre o próximo processo de boot do Windows: o NTLDR.
...
Para os sabichões de plantão, inclusive os que me criticaram (?) no meu [último texto humorístico](http://www.caloni.com.br/blog/archives/programadores-de-verdade-nao-usam-java) sobre como Java é podre, eu sei que o bicho da capa não é uma galinha, mas um urubu. A troca de urubu por galinha vem do requisito básico para você fazer trabalhos esotéricos, como macumba e desenvolvimento de drivers: uma galinha preta na encruzilhada. Alguns usam [um papel dentro da boca de um sapo](http://www.driverentry.com.br/blog/2006/10/serial-killers.html), mas vai do gosto de cada um. =)
...
![ntldr-phase.png](http://www.caloni.com.br/blog/wp-content/uploads/ntldr-phase.png)
...
![é ele que exibe o menu de boot do sistema operacional??](http://www.caloni.com.br/blog/wp-content/uploads/ntldr.png)
...
![driver-atapi.png](http://www.caloni.com.br/blog/wp-content/uploads/driver-atapi.png)
...
A partir daí vários componentes do kernel serão carregados progressivamente. Só que a partir do momento que é chamada a rotina interna **KiInitializeKernel** o NTLDR não tem mais nada pra fazer: o kernel, em sua forma básica e primitiva, está carregado.
    ...
    windbg notepad
    $$>a<<a href="http://www.caloni.com.br/blog/archives/carregando-dlls-arbitrarias-pelo-windbg-parte-2">scripts\loadlibrary.txt</a> <strong>ntoskrnl.exe</strong>
