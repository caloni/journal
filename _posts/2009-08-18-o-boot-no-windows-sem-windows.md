...
Se for detectar algum problema no sistema de boot baseado em MBR, então você tem dois caminhos:
  ...
  * Usar o **SoftICE 16 bits** e [depurar o carregamento da MBR pela BIOS](http://www.caloni.com.br/blog/archives/debug-da-bios-com-o-softice-16-bits)

	
  * Usar o **Debug 16 bits** do MS-DOS (ou similar) e [depurar diretamente o código de boot da MBR](http://www.caloni.com.br/blog/archives/depuracao-da-mbr), reproduzindo os passos anteriores da BIOS.
