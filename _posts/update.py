...
def writereview(filePath, header, review, imdbData):
  ...
  if imdbData.has_key('title'): 
    ...
    #fileName = os.path.basename(filePath)[11:][:-3]
  ...
  #    CoversDownloader.retrieve(coverUrl, CoversPath + '\\' + fileName)
  #    _resizeimage(CoversPath + '\\' + fileName)
  f.write('---\n')
  f.write(review)
  f.close()
...
def _resizeimage(imgPath):
  img = Image.open(imgPath)
  img = img.resize(DefaultCoverSize)
  img.save(imgPath)
