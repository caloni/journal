...
author: admin
comments: true
date: 2007-09-24 20:26:33+00:00
layout: post
slug: why-is-my-dll-locked
...
In order to the see the locking code in action, download the [DLL](http://www.caloni.com.br/blog/wp-content/uploads/loaderlock.cpp) and [EXE](http://www.caloni.com.br/blog/wp-content/uploads/loaderlock-exe.cpp) source files and use the following commands to generate the executable files:
