...
_writer: ["James Baldwin", ]
_cast: ["Samuel L. Jackson (Narration)", "James Baldwin (Himself)", "Dick Cavett (Himself)", "Shumerria Harris (Herself)", ]
_countries: ["France", ]
_languages: ["English", ]
_editor: ["Alexandra Strauss", ]
_cinematographer: ["Henry Adebonojo", "Bill Ross IV", "Turner Ross", ]
_music: ["Alexei Aigui", ]
_genres: ["Documentary", ]
_runtimes: ["95", ]
...
Crítica completa na estreia do filme _{{ page._releasedate | default:'data indefinida' | prepend:'(' | append:')' }}_ no CinemAqui](http://www.cinemaqui.com.br/eu-nao-sou-seu-negro) em breve.
