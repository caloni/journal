...
Crítica completa na estreia do filme _{{ page._releasedate | default:'data indefinida' | prepend:'(' | append:')' }}_ no CinemAqui](http://www.cinemaqui.com.br/bugigangue-no-espaco).
