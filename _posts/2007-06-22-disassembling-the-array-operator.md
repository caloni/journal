...
The quote[index] bellow shows that we can use both orders and the code will compile successfully ([try it](http://www.caloni.com.br/blog/wp-content/uploads/2007/06/disassembling-array.cpp)!).
