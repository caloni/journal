...
![Serviço do PsExec criado na máquina-alvo.](../public/uploads/psexec-service.png)
...
![Instalação do Serviço PsExec na máquina-alvo no registro do Windows.](../public/uploads/psexec-service-installation.png)

![Arquivo do serviço do PsExec instalado na máquina-alvo na pasta c:\Windows.](../public/uploads/psexec-service-file.png)
...
![Compartilhamento admin$ disponível enquanto depuramos o PsExec.](../public/uploads/admin-sharing.png)
