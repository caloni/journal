...
function MetadataParser_GetChapterFromDateField(a_date,    l_words, l_first)
{
...
function MetadataParser_CopyNewPost(    l_slug, l_chapter)
{
  l_slug = G_NEW_POST["slug"]
  l_chapter = MetadataParser_GetChapterFromDateField(G_NEW_POST["date"])
